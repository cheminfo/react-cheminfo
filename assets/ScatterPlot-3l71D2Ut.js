import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{h as t,n}from"./iframe-c810BdAw.js";import{i as r,n as i,s as a,u as o}from"./chartScale-CW5Od2vP.js";import{A as s,C as c,E as l,M as u,S as d,T as f,_ as p,a as m,b as h,c as g,d as _,f as v,i as y,j as b,k as x,l as S,m as C,n as ee,o as te,p as ne,r as w,s as re,t as T,u as ie,v as E,w as D,x as O,y as k}from"./useScatterLabels-DXLfCdC7.js";import{w as A}from"./projectionFixtures-CiYcRfZJ.js";import{n as j,t as ae}from"./ChartFrame-BPG0eLVd.js";function M(e){let{scores:t,groupOf:n,groups:r,axes:i}=e,{size:a=O,minimumPoints:o=3}=e;return{...l(t,n,r,i),standardDeviations:d(a),minimumPoints:o}}function N(e,t,n,r){let{standardDeviations:i,minimumPoints:a}=e;return D(e,{group:t,xAxis:n,yAxis:r,standardDeviations:i,minimumPoints:a})}function P(){return(P=e((()=>{c(),f()})))()}function oe(e,t,n){let r=Math.cos(e.angle),i=Math.sin(e.angle),a=e.rx*e.rx,o=e.ry*e.ry,s=a*r*r+o*i*i,c=(a-o)*r*i,l=a*i*i+o*r*r,u=t.factor*n.factor,d=x({xx:t.factor*t.factor*s,xy:u*c,yy:n.factor*n.factor*l}),f={cx:t.offset+e.cx*t.factor,cy:n.offset+e.cy*n.factor,rx:d.rx,ry:d.ry,angleDegrees:d.angle*F/Math.PI};return!Number.isFinite(f.cx)||!Number.isFinite(f.cy)||!Number.isFinite(f.rx)||!Number.isFinite(f.ry)||!Number.isFinite(f.angleDegrees)?null:f}function se(e,t=I){let n=Number.isFinite(t)?Math.max(L,Math.floor(t)):I,r=Math.cos(e.angle),i=Math.sin(e.angle),a=Array(n);for(let t=0;t<n;t++){let o=2*Math.PI*t/n,s=e.rx*Math.cos(o),c=e.ry*Math.sin(o);a[t]={x:e.cx+s*r-c*i,y:e.cy+s*i+c*r}}return a}var F,I,L;function R(){return(R=e((()=>{s(),F=180,I=64,L=3})))()}function z(e,t,n,r,i){let a=oe(t,n,r);return a===null?V(e,t,n,r,i):B(e,a,i)}function B(e,t,n){let{cx:r,cy:a,rx:o,ry:s,angleDegrees:c}=t,l={"data-group":e,opacity:n.opacity};if(s>0)return(0,U.jsx)(`ellipse`,{...l,...H(n),cx:i(r),cy:i(a),rx:i(o),ry:i(s),transform:`rotate(${i(c)} ${i(r)} ${i(a)})`},e);let u=c*Math.PI/G,d=o*Math.cos(u),f=o*Math.sin(u);return(0,U.jsx)(`line`,{...l,fill:`none`,stroke:n.color,strokeWidth:W,x1:i(r-d),y1:i(a-f),x2:i(r+d),y2:i(a+f)},e)}function V(e,t,n,r,a){let o=se(t),s=``;for(let e=0;e<o.length;e++){let t=o[e];if(t===void 0)continue;let a=i(n.offset+t.x*n.factor),c=i(r.offset+t.y*r.factor);s+=`${e===0?`M`:`L`}${a} ${c}`}return(0,U.jsx)(`path`,{"data-group":e,d:s===``?s:`${s}Z`,opacity:a.opacity,...H(a)},e)}function H(e){let t=e.fillOpacity??.1;return t>0?{fill:e.color,fillOpacity:t}:{fill:`none`}}var U,W,G;function K(){return(K=e((()=>{r(),R(),U=n(),W=1.5,G=180,z.__docgenInfo={description:`One group outline, mapped onto a plot and ready to be drawn.
