import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{h as t,n}from"./iframe-DR65Tpnu.js";import{D as r,O as i,g as a,h as o,n as s,o as c,r as l,s as u}from"./projectionFixtures-CiYcRfZJ.js";import{i as d,n as f,r as p,t as m}from"./OverlayLegend-BRYTeAQV.js";import{n as h,t as g}from"./ScatterPlot-BmgZpfP9.js";function _(e){let{overlay:t,muted:n}=e;return(0,S.jsx)(g,{x:c,y:u,width:C.width,height:C.height,xAxis:a(0),yAxis:a(1),groupOf:l,groups:s,ellipse:{kind:`coverage`,probability:.95},mutedGroups:n===void 0?void 0:new Set([n]),overlay:t})}function v(e){let[t,n]=(0,x.useState)(new Set);return(0,S.jsxs)(`div`,{style:I,children:[(0,S.jsx)(g,{x:c,y:u,width:C.width,height:C.height,xAxis:a(0),yAxis:a(1),groupOf:l,groups:s,ellipse:{kind:`coverage`,probability:.95},mutedGroups:t,overlay:(0,S.jsx)(m,{placement:`top-left`,title:e.title,entries:E.map(e=>({...e,muted:t.has(e.id)})),onToggle:e=>{let r=new Set(t);r.delete(e)||r.add(e),n(r)}})}),(0,S.jsx)(`p`,{style:L,children:y(t)})]})}function y(e){if(e.size===0)return`Every species is drawn in full.`;let t=[];for(let n of s)e.has(n.id)&&t.push(n.label);return`Drawn faint: ${t.join(`, `)}.`}function b(){let e=new Int32Array(s.length);for(let t of l)t>=0&&(e[t]=(e[t]??0)+1);return e}var x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R;function z(){return(z=e((()=>{x=t(),i(),d(),f(),h(),o(),S=n(),C={width:720,height:420},w=`Colour = species, ring = 95% of that species`,T=b(),E=s.map((e,t)=>({...e,count:T[t]??0})),D={dot:`Sample the model was fitted on`,ring:`Sample placed into the finished model`,square:`Group mean`,line:`Component`,dashed:`Outline of a group`,cross:`Cluster centre`},O=[0,1,2,3,5,6],k=p.map((e,t)=>({id:e,label:D[e]??e,color:r(O[t]??0),shape:e})),A={title:`Overlay/OverlayLegend`,component:m,args:{title:w,entries:E,placement:`top-left`},parameters:{layout:`padded`,docs:{description:{component:"The card that says what colour and shape mean on a figure. Give it an `onToggle` and the same card becomes the filter: pressing an entry hides what it names. Its title has no default on purpose — a legend that does not name its encoding is how a reader carries the wrong meaning from one tab to the next."}}},render:e=>(0,S.jsx)(_,{overlay:(0,S.jsx)(m,{...e})})},j={},M={args:{title:`What each mark stands for`,entries:k,placement:`below`},render:e=>(0,S.jsx)(m,{...e})},N={render:e=>(0,S.jsx)(v,{title:e.title})},P={args:{entries:E.map(e=>e.id===`versicolor`?{...e,muted:!0}:e)},render:e=>(0,S.jsx)(_,{muted:`versicolor`,overlay:(0,S.jsx)(m,{...e})})},F={args:{title:`Colour = species, ring = 95% of that species`,entries:[...E,{id:`outline`,label:`Outline`,color:`var(--text-muted)`,shape:`dashed`,note:`Drawn only for a species with at least three flowers.`}]}},I={display:`flex`,flexDirection:`column`,gap:8},L={margin:0,color:`var(--text-muted)`,fontSize:13},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{}`,...j.parameters?.docs?.source},description:{story:`Three species, each with the count it covers, over the map they are read from.`,...j.parameters?.docs?.description}}},M.parameters={...M.parameters,docs:{...M.parameters?.docs,source:{originalSource:`{
  args: {
