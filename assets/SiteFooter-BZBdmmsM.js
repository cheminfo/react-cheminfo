import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{n as t,o as n,r,s as i}from"./lookup-DaL5dO87.js";import{n as a}from"./iframe-DzkT2GF_.js";import{i as o,n as s,r as c,t as l}from"./useT-SaARZZCl.js";import{n as u}from"./joinClassNames-BbK_6p9Z.js";import{n as d,r as f}from"./familyTokens-DsQXXJV4.js";import{i as p,n as m,r as h,t as g}from"./ecosystemStyles-ADI9QT6F.js";function _(e){let n=o(),{className:r,currentSiteId:a,heading:c,layout:l=`grid`}=e,d=s(),f=c??d(`ecosystem.otherTools`);return(0,v.jsxs)(`nav`,{className:u(`ecosystem-links`,r),style:y,"aria-label":f,children:[(0,v.jsx)(`h2`,{style:g,children:f}),l===`grid`?(0,v.jsx)(h,{currentSiteId:a}):(0,v.jsx)(`div`,{style:b,children:t().map(({group:e,sites:t})=>(0,v.jsxs)(`div`,{style:x,children:[(0,v.jsx)(`span`,{style:S,children:d.or(`ecosystem.group.${e.id}.label`,e.label)}),t.map(e=>e.id===a?(0,v.jsx)(`span`,{style:w,children:e.host},e.id):(0,v.jsx)(`a`,{style:{...C,color:e.brand},href:i(e,{language:n}),children:e.host},e.id))]},e.id))})]})}var v,y,b,x,S,C,w;function T(){return(T=e((()=>{l(),c(),f(),r(),n(),p(),m(),v=a(),y={display:`flex`,flexDirection:`column`,gap:8},b={display:`flex`,flexDirection:`column`,gap:6},x={display:`flex`,flexWrap:`wrap`,alignItems:`baseline`,gap:`0.3rem 0.85rem`},S={color:d.textFaint,fontSize:`0.6875rem`,fontWeight:700,letterSpacing:`0.06em`,textTransform:`uppercase`},C={fontSize:`0.8125rem`,fontWeight:600,textDecoration:`none`,whiteSpace:`nowrap`},w={...C,color:d.textFaint,cursor:`default`},_.__docgenInfo={description:`Every site of the family as a plain link, gathered under its topic, for the
...
@default the chrome's own line, in the language of the page`},layout:{required:!1,tsType:{name:`union`,raw:`'grid' | 'row'`,elements:[{name:`literal`,value:`'grid'`},{name:`literal`,value:`'row'`}]},description:`How much of each site is written. \`grid\` gives every site its mark, its
...
@default undefined`}}}})))()}function E(e){let{siteId:t,layout:n=`grid`,heading:r,embedded:i=!1,children:a,width:o=`page`}=e;return i?null:(0,D.jsx)(`footer`,{className:`app-footer no-print`,children:(0,D.jsxs)(`div`,{className:O[o],children:[(0,D.jsx)(_,{currentSiteId:t,layout:n,heading:r}),a]})})}var D,O;function k(){return(k=e((()=>{T(),D=a(),O={page:`app-footer__inner`,full:`app-footer__inner app-footer__inner--full`},E.__docgenInfo={description:`The strip under every page of the family: each sibling site as a plain link,
