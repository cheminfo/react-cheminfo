import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{h as t,n}from"./iframe-BFq2-A0J.js";import{a as r,i,l as a,n as o}from"./chartScale-Cx3ulN9E.js";import{A as s,C as c,E as l,M as u,S as d,T as f,_ as ee,a as p,b as te,c as m,d as h,f as g,i as _,j as v,k as y,l as b,m as ne,n as x,o as S,p as re,r as C,s as ie,t as w,u as ae,v as oe,w as T,x as E,y as D}from"./useScatterLabels-sJjIiZGX.js";import{k as O}from"./projectionFixtures-BZtvIH15.js";import{n as k,t as se}from"./ChartFrame-DSaBBHE8.js";function A(e){let{scores:t,groupOf:n,groups:r,axes:i}=e,{size:a=E,minimumPoints:o=3}=e;return{...l(t,n,r,i),standardDeviations:d(a),minimumPoints:o}}function j(e,t,n,r){let{standardDeviations:i,minimumPoints:a}=e;return T(e,{group:t,xAxis:n,yAxis:r,standardDeviations:i,minimumPoints:a})}function M(){return(M=e((()=>{c(),f()})))()}function N(e,t,n){let r=Math.cos(e.angle),i=Math.sin(e.angle),a=e.rx*e.rx,o=e.ry*e.ry,s=a*r*r+o*i*i,c=(a-o)*r*i,l=a*i*i+o*r*r,u=t.factor*n.factor,d=y({xx:t.factor*t.factor*s,xy:u*c,yy:n.factor*n.factor*l}),f={cx:t.offset+e.cx*t.factor,cy:n.offset+e.cy*n.factor,rx:d.rx,ry:d.ry,angleDegrees:d.angle*F/Math.PI};return!Number.isFinite(f.cx)||!Number.isFinite(f.cy)||!Number.isFinite(f.rx)||!Number.isFinite(f.ry)||!Number.isFinite(f.angleDegrees)?null:f}function P(e,t=I){let n=Number.isFinite(t)?Math.max(L,Math.floor(t)):I,r=Math.cos(e.angle),i=Math.sin(e.angle),a=Array(n);for(let t=0;t<n;t++){let o=2*Math.PI*t/n,s=e.rx*Math.cos(o),c=e.ry*Math.sin(o);a[t]={x:e.cx+s*r-c*i,y:e.cy+s*i+c*r}}return a}var F,I,L;function R(){return(R=e((()=>{s(),F=180,I=64,L=3})))()}function z(e,t,n,r,i){let a=N(t,n,r);return a===null?V(e,t,n,r,i):B(e,a,i)}function B(e,t,n){let{cx:r,cy:i,rx:a,ry:s,angleDegrees:c}=t,l={"data-group":e,opacity:n.opacity};if(s>0)return(0,U.jsx)(`ellipse`,{...l,...H(n),cx:o(r),cy:o(i),rx:o(a),ry:o(s),transform:`rotate(${o(c)} ${o(r)} ${o(i)})`},e);let u=c*Math.PI/G,d=a*Math.cos(u),f=a*Math.sin(u);return(0,U.jsx)(`line`,{...l,fill:`none`,stroke:n.color,strokeWidth:W,x1:o(r-d),y1:o(i-f),x2:o(r+d),y2:o(i+f)},e)}function V(e,t,n,r,i){let a=P(t),s=``;for(let e=0;e<a.length;e++){let t=a[e];if(t===void 0)continue;let i=o(n.offset+t.x*n.factor),c=o(r.offset+t.y*r.factor);s+=`${e===0?`M`:`L`}${i} ${c}`}return(0,U.jsx)(`path`,{"data-group":e,d:s===``?s:`${s}Z`,opacity:i.opacity,...H(i)},e)}function H(e){let t=e.fillOpacity??.1;return t>0?{fill:e.color,fillOpacity:t}:{fill:`none`}}var U,W,G;function K(){return(K=e((()=>{i(),R(),U=n(),W=1.5,G=180,z.__docgenInfo={description:`One group outline, mapped onto a plot and ready to be drawn.
...
@returns The element, keyed by group.`,methods:[],displayName:`scatterOutlineShape`}})))()}var q,J,Y;function X(){return(X=e((()=>{q=t(),c(),M(),K(),J=n(),Y=(0,q.memo)(function(e){let{x:t,y:n,groupOf:r,colors:i,scaleX:a,scaleY:o,size:s=E,minimumPoints:c=3,opacities:l,fillOpacity:u}=e,d=A({scores:O([t,n]),groupOf:r,groups:i.length,axes:2,size:s,minimumPoints:c}),f=[];for(let e=0;e<i.length;e++){let t=i[e];if(t===void 0)continue;let n=j(d,e,0,1);if(n===null)continue;let r={color:t,opacity:l?.[e],fillOpacity:u};f.push(z(e,n,a,o,r))}return(0,J.jsx)(`g`,{"data-layer":`ellipses`,children:f})}),Y.__docgenInfo={description:`One outline per group, drawn through both scales.
...
compound.
@default SCATTER_OUTLINE_FILL_OPACITY`}}}})))()}function ce(e){let{x:t,y:n,width:r,height:i,xAxis:a,yAxis:o}=e,{viewport:s,onViewportChange:c,wheelZoom:l=!1}=e,{wheelZoomDelay:d}=e,[f,ee]=(0,Q.useState)(null),p=s===void 0?f:s,m=(0,Q.useMemo)(()=>({x:Z(a),y:Z(o)}),[a,o]),h=(0,Q.useMemo)(()=>p===null?{x:a,y:o}:{x:{...a,domain:p.x,nice:!1},y:{...o,domain:p.y,nice:!1}},[p,a,o]),_=(0,Q.useMemo)(()=>g(t,n,r,i,h.x,h.y),[t,n,r,i,h]),v=(0,Q.useCallback)(e=>{s===void 0&&ee(e),c?.(e)},[c,s]),y=(0,Q.useCallback)(()=>{p!==null&&v(null)},[v,p]),b=u({enabled:l,delay:d,onZoom:(e,t,n)=>{v(ne(m,p,e,t,n))}}),x=(0,Q.useMemo)(()=>{if(p===null)return;let{points:e,rect:t}=_;return te(e,{minX:t.x,minY:t.y,maxX:t.x+t.width,maxY:t.y+t.height})},[p,_]);return{..._,xAxis:h.x,yAxis:h.y,viewport:p,inside:x,ref:b.ref,reset:y}}function Z(e){return r(e.domain[0],e.domain[1],{count:e.tickCount,nice:e.nice}).domain}var Q;function le(){return(le=e((()=>{Q=t(),a(),v(),D(),b()})))()}function ue(e){let{x:t,y:n,width:r,height:i,xAxis:a,yAxis:o,groupOf:s,groups:c}=e,{mutedGroups:l,shapeOf:u,shapes:d}=e,{ellipse:f=null,ellipseMinimumPoints:te}=e,{ellipseFillOpacity:m,showGroupMeans:g,markers:v}=e,{pointRadius:y=3.5,outlinedFrom:b,pointLabels:ne}=e,{showGroupLabels:S=!1,selected:C,defaultSelected:w}=e,{onSelectionChange:oe,selectMode:T,onHoverChange:E,onPinChange:D}=e,{onPointDoubleClick:O,onLassoChange:k,touchLasso:A,viewport:j}=e,{onViewportChange:M,wheelZoom:N,wheelZoomDelay:P,overlay:F}=e,{label:I,className:L,testId:R}=e,z=ce({x:t,y:n,width:r,height:i,xAxis:a,yAxis:o,viewport:j,onViewportChange:M,wheelZoom:N,wheelZoomDelay:P}),{points:B,rect:V,toX:H,toY:U,inside:W,geometry:G}=z,{ref:K,reset:q}=z,J=(0,de.useMemo)(()=>ae(c,l),[c,l]),X=x(B,{pointLabels:ne,showGroupLabels:S,groups:c,groupOf:s,colors:J.colors,radius:y,bounds:V}),Z=_({points:B,originX:V.x,originY:V.y,selected:C,defaultSelected:w,onSelectionChange:oe,selectMode:T,touchLasso:A,included:W,hoverRadius:y+8,onHoverChange:E,onPinChange:D,onLassoChange:k});function Q(e){let t=Z.openAt(e);if(t===null||O===void 0){q();return}O(t)}return(0,$.jsx)(se,{width:r,height:i,x:z.xAxis,y:z.yAxis,geometry:G,busy:Z.lasso.drawing,overlay:F,className:L,testId:R,label:I??re(a,o,B.x.length),children:()=>(0,$.jsxs)($.Fragment,{children:[f===null||s===void 0?null:(0,$.jsx)(Y,{x:t,y:n,groupOf:s,colors:J.colors,opacities:J.opacities,scaleX:H,scaleY:U,size:f,minimumPoints:te,fillOpacity:m}),(0,$.jsx)(p,{points:B,groupOf:s,colors:J.colors,opacities:J.opacities,shapeOf:u,shapes:d,radius:y,outlinedFrom:b}),(0,$.jsx)(ee,{points:B,selected:Z.selection.mask,hovered:Z.hover.hovered,focused:Z.keyboard.cursor,radius:y,groupOf:s,colors:J.colors,showGroupMeans:g,marks:h(v,H,U)}),(0,$.jsx)(ie,{labels:X,radius:y,lassoPath:Z.lasso.pathData}),(0,$.jsx)(`rect`,{...V,ref:K,fill:`transparent`,tabIndex:0,onKeyDown:Z.keyboard.onKeyDown,onDoubleClick:Q,...Z.surface})]})})}var de,$;function fe(){return(fe=e((()=>{de=t(),k(),X(),oe(),m(),S(),b(),le(),C(),w(),$=n(),ue.__docgenInfo={description:`A cloud of points with a lasso, group outlines and a hover card.
...
@default undefined — every group is drawn in full`},shapeOf:{required:!1,tsType:{name:`ArrayLike`,elements:[{name:`number`}],raw:`ArrayLike<number>`},description:"Which shape each point takes, as an index into `shapes`: a second\ngrouping of the same points, drawn while colour keeps the first. A point\nwith `-1`, `NaN`, or an index outside the range, is a disc.\n@default undefined — every point is a disc"},shapes:{required:!1,tsType:{name:`unknown`},description:"The shapes, in the order `shapeOf` names them.\n@default undefined"},pointRadius:{required:!1,tsType:{name:`number`},description:`Radius of a dot, in pixels. A cloud draws the dot at the middle of its box
...
@default false`}}}})))()}export{M as a,z as i,fe as n,A as o,K as r,j as s,ue as t};