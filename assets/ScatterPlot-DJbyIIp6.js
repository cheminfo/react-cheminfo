import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{h as t,n}from"./iframe-vuJI5ajg.js";import{C as r,T as i,b as a,v as o}from"./chartFrameGeometry-CYHWhbkM.js";import{A as s,C as c,D as l,E as u,F as d,I as f,L as p,O as m,P as h,S as g,T as _,c as v,d as y,f as b,g as ee,h as te,i as x,j as S,k as C,l as ne,m as w,n as re,p as ie,r as T,s as ae,t as E,u as D,w as O}from"./useScatterLabels-QoSQJMu9.js";import{w as k}from"./projectionFixtures-CiYcRfZJ.js";import{n as A,t as oe}from"./ChartFrame-1gnPG4E0.js";function j(e){let{scores:t,groupOf:n,groups:r,axes:i}=e,{size:a=u,minimumPoints:o=3}=e;return{...S(t,n,r,i),standardDeviations:l(a),minimumPoints:o}}function M(e,t,n,r){let{standardDeviations:i,minimumPoints:a}=e;return C(e,{group:t,xAxis:n,yAxis:r,standardDeviations:i,minimumPoints:a})}function N(){return(N=e((()=>{m(),s()})))()}function se(e,t,n){let r=Math.cos(e.angle),i=Math.sin(e.angle),a=e.rx*e.rx,o=e.ry*e.ry,s=a*r*r+o*i*i,c=(a-o)*r*i,l=a*i*i+o*r*r,u=t.factor*n.factor,d=h({xx:t.factor*t.factor*s,xy:u*c,yy:n.factor*n.factor*l}),f={cx:t.offset+e.cx*t.factor,cy:n.offset+e.cy*n.factor,rx:d.rx,ry:d.ry,angleDegrees:d.angle*F/Math.PI};return!Number.isFinite(f.cx)||!Number.isFinite(f.cy)||!Number.isFinite(f.rx)||!Number.isFinite(f.ry)||!Number.isFinite(f.angleDegrees)?null:f}function P(e,t=I){let n=Number.isFinite(t)?Math.max(L,Math.floor(t)):I,r=Math.cos(e.angle),i=Math.sin(e.angle),a=Array(n);for(let t=0;t<n;t++){let o=2*Math.PI*t/n,s=e.rx*Math.cos(o),c=e.ry*Math.sin(o);a[t]={x:e.cx+s*r-c*i,y:e.cy+s*i+c*r}}return a}var F,I,L;function R(){return(R=e((()=>{d(),F=180,I=64,L=3})))()}function z(e,t,n,r,i){let a=se(t,n,r);return a===null?V(e,t,n,r,i):B(e,a,i)}function B(e,t,n){let{cx:r,cy:i,rx:a,ry:s,angleDegrees:c}=t,l={"data-group":e,opacity:n.opacity};if(s>0)return(0,U.jsx)(`ellipse`,{...l,...H(n),cx:o(r),cy:o(i),rx:o(a),ry:o(s),transform:`rotate(${o(c)} ${o(r)} ${o(i)})`},e);let u=c*Math.PI/G,d=a*Math.cos(u),f=a*Math.sin(u);return(0,U.jsx)(`line`,{...l,fill:`none`,stroke:n.color,strokeWidth:W,x1:o(r-d),y1:o(i-f),x2:o(r+d),y2:o(i+f)},e)}function V(e,t,n,r,i){let a=P(t),s=``;for(let e=0;e<a.length;e++){let t=a[e];if(t===void 0)continue;let i=o(n.offset+t.x*n.factor),c=o(r.offset+t.y*r.factor);s+=`${e===0?`M`:`L`}${i} ${c}`}return(0,U.jsx)(`path`,{"data-group":e,d:s===``?s:`${s}Z`,opacity:i.opacity,...H(i)},e)}function H(e){let t=e.fillOpacity??.1;return t>0?{fill:e.color,fillOpacity:t}:{fill:`none`}}var U,W,G;function K(){return(K=e((()=>{a(),R(),U=n(),W=1.5,G=180,z.__docgenInfo={description:`One group outline, mapped onto a plot and ready to be drawn.
...
@returns The element, keyed by group.`,methods:[],displayName:`scatterOutlineShape`}})))()}var q,J,Y;function X(){return(X=e((()=>{q=t(),m(),N(),K(),J=n(),Y=(0,q.memo)(function(e){let{x:t,y:n,groupOf:r,colors:i,scaleX:a,scaleY:o,size:s=u,minimumPoints:c=3,opacities:l,fillOpacity:d}=e,f=j({scores:k([t,n]),groupOf:r,groups:i.length,axes:2,size:s,minimumPoints:c}),p=[];for(let e=0;e<i.length;e++){let t=i[e];if(t===void 0)continue;let n=M(f,e,0,1);if(n===null)continue;let r={color:t,opacity:l?.[e],fillOpacity:d};p.push(z(e,n,a,o,r))}return(0,J.jsx)(`g`,{"data-layer":`ellipses`,children:p})}),Y.__docgenInfo={description:`One outline per group, drawn through both scales.
...
compound.
@default SCATTER_OUTLINE_FILL_OPACITY`}}}})))()}function ce(e){let{x:t,y:n,width:r,height:i,xAxis:a,yAxis:o}=e,{viewport:s,onViewportChange:c,wheelZoom:l=!1}=e,{wheelZoomDelay:u}=e,[d,f]=(0,Z.useState)(null),m=s===void 0?d:s,h=(0,Z.useMemo)(()=>({x:le(a),y:le(o)}),[a,o]),g=(0,Z.useMemo)(()=>m===null?{x:a,y:o}:{x:{...a,domain:m.x,nice:!1},y:{...o,domain:m.y,nice:!1}},[m,a,o]),v=(0,Z.useMemo)(()=>w(t,n,r,i,g.x,g.y),[t,n,r,i,g]),y=(0,Z.useCallback)(e=>{s===void 0&&f(e),c?.(e)},[c,s]),b=(0,Z.useCallback)(()=>{m!==null&&y(null)},[y,m]),te=p({enabled:l,delay:u,onZoom:(e,t,n)=>{y(ee(h,m,e,t,n))}}),x=(0,Z.useMemo)(()=>{if(m===null)return;let{points:e,rect:t}=v;return _(e,{minX:t.x,minY:t.y,maxX:t.x+t.width,maxY:t.y+t.height})},[m,v]);return{...v,xAxis:g.x,yAxis:g.y,viewport:m,inside:x,ref:te.ref,reset:b}}function le(e){return r(e.domain[0],e.domain[1],{count:e.tickCount,nice:e.nice}).domain}var Z;function ue(){return(ue=e((()=>{Z=t(),i(),f(),O(),y()})))()}function Q(e){let{x:t,y:n,width:r,height:i,xAxis:a,yAxis:o,groupOf:s,groups:c}=e,{mutedGroups:l,ellipse:u=null,ellipseMinimumPoints:d}=e,{ellipseFillOpacity:f,showGroupMeans:p,markers:m}=e,{pointRadius:h=3.5,outlinedFrom:_,pointLabels:v}=e,{showGroupLabels:y=!1,selected:ee,defaultSelected:S}=e,{onSelectionChange:C,selectMode:w,onHoverChange:T,onPinChange:E}=e,{onPointDoubleClick:D,onLassoChange:O,touchLasso:k,viewport:A}=e,{onViewportChange:j,wheelZoom:M,wheelZoomDelay:N,overlay:se}=e,{label:P,className:F,testId:I}=e,L=ce({x:t,y:n,width:r,height:i,xAxis:a,yAxis:o,viewport:A,onViewportChange:j,wheelZoom:M,wheelZoomDelay:N}),{points:R,rect:z,toX:B,toY:V,inside:H,geometry:U}=L,{ref:W,reset:G}=L,K=(0,de.useMemo)(()=>b(c,l),[c,l]),q=re(R,{pointLabels:v,showGroupLabels:y,groups:c,groupOf:s,colors:K.colors,radius:h,bounds:z}),J=x({points:R,originX:z.x,originY:z.y,selected:ee,defaultSelected:S,onSelectionChange:C,selectMode:w,touchLasso:k,included:H,hoverRadius:h+8,onHoverChange:T,onPinChange:E,onLassoChange:O});function X(e){let t=J.openAt(e);if(t===null||D===void 0){G();return}D(t)}return(0,$.jsx)(oe,{width:r,height:i,x:L.xAxis,y:L.yAxis,geometry:U,busy:J.lasso.drawing,overlay:se,className:F,testId:I,label:P??te(a,o,R.x.length),children:()=>(0,$.jsxs)($.Fragment,{children:[u===null||s===void 0?null:(0,$.jsx)(Y,{x:t,y:n,groupOf:s,colors:K.colors,opacities:K.opacities,scaleX:B,scaleY:V,size:u,minimumPoints:d,fillOpacity:f}),(0,$.jsx)(ae,{points:R,groupOf:s,colors:K.colors,opacities:K.opacities,radius:h,outlinedFrom:_}),(0,$.jsx)(g,{points:R,selected:J.selection.mask,hovered:J.hover.hovered,focused:J.keyboard.cursor,radius:h,groupOf:s,colors:K.colors,showGroupMeans:p,marks:ie(m,B,V)}),(0,$.jsx)(ne,{labels:q,radius:h,lassoPath:J.lasso.pathData}),(0,$.jsx)(`rect`,{...z,ref:W,fill:`transparent`,tabIndex:0,onKeyDown:J.keyboard.onKeyDown,onDoubleClick:X,...J.surface})]})})}var de,$;function fe(){return(fe=e((()=>{de=t(),A(),X(),c(),D(),v(),y(),ue(),T(),E(),$=n(),Q.__docgenInfo={description:`A cloud of points with a lasso, group outlines and a hover card.
...
@default false`}}}})))()}export{N as a,z as i,fe as n,j as o,K as r,M as s,Q as t};