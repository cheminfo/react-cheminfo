import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{n as t}from"./iframe-BFq2-A0J.js";import{n,t as r}from"./CiteButton-Box7rev_.js";import{n as i,r as a,t as o}from"./paper-B3w0LQN3.js";import{r as s,t as c}from"./headerButton-DRQf5QD1.js";var l,u,d,f,p,m,h,g,_,v;function y(){return(y=e((()=>{n(),s(),a(),l=t(),u={title:`Citation/CiteButton`,component:r,argTypes:c,parameters:{docs:{description:{component:"The Cite entry of a site header. Open it, hover an entry for the preview, and the styles sit in the submenu. A site built on several works passes `works` rather than `reference`, and each is listed behind what citing it credits."}}}},d={args:{reference:o}},f={args:{reference:o,label:`Cite this work`}},p={args:{reference:o,placement:`bottom-start`}},m={args:{reference:o,compact:!0}},h={args:{works:i}},g={args:{works:i,guidance:`Cite the calculator, and the platform it runs on`}},_={args:{reference:o},parameters:{layout:`padded`},render:e=>(0,l.jsx)(`div`,{className:`sb-header`,style:{width:`min(60rem, 90vw)`},children:(0,l.jsx)(r,{...e})})},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
    reference: PAPER
  }
