import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{f as t,n}from"./iframe-D72pBctd.js";import{n as r,t as i}from"./icon-BlJt7NJz.js";import{n as a,t as o}from"./components-JiWAcHp-.js";import{n as s,t as c}from"./htmlSelect-CCycpvzq.js";import{i as l,n as u,r as d,t as f}from"./menuItem-Bx_Jp4uU.js";import{i as p,r as m}from"./popoverNextMigrationUtils-DfPthqdx.js";import{n as h,t as g}from"./menuDivider-B08bTEVp.js";import{n as _,t as v}from"./HelpTooltip-D1R2wOWf.js";import{B as y,G as ee,H as te,I as b,J as ne,K as re,R as x,U as ie,V as S,W as ae,q as oe,z as se}from"./projectionFixtures-DkPtYRxh.js";import{n as ce,t as le}from"./HelpIcon-DLVDnFQV.js";import{n as ue,t as de}from"./listNavigation-DtROoc3V.js";import{n as fe,t as pe}from"./useContainerSize-BGrZo8Ko.js";function C(){return(0,me.useContext)(he)}var me,he;function w(){return(w=e((()=>{me=t(),he=(0,me.createContext)(void 0)})))()}function ge(e){return{display:`inline-flex`,alignItems:`center`,gap:Math.max(4,e.gap-2),minHeight:e.controlHeight}}function _e(e,t){return{display:`grid`,gridTemplateColumns:`${t}px minmax(0, 1fr)`,alignItems:`center`,columnGap:Math.max(10,e.gap+2),minHeight:e.controlHeight,width:`100%`}}function ve(e){return e.labelSize*8+8}function ye(e,t){let{help:n=!1,disabled:r=!1}=t;return{color:`var(--text-muted)`,fontSize:e.labelSize,fontWeight:500,whiteSpace:`nowrap`,userSelect:`none`,...n?T:void 0,...r?Se:void 0}}function be(e){return{display:`inline-flex`,flexDirection:`column`,alignItems:`flex-start`,gap:2,minHeight:e.controlHeight}}var xe,T,Se;function E(){return(E=e((()=>{xe={display:`flex`,alignItems:`center`,minWidth:0},T={textDecoration:`underline dotted var(--border-strong)`,textUnderlineOffset:3,cursor:`help`},Se={opacity:.6}})))()}function D(e){let{children:t,label:n,help:r,hideLabel:i=!1,disabled:a=!1,testId:o,labelPlacement:s=`inline`}=e,{metrics:c}=x(),l=C(),u=e.layout??(l===void 0?`row`:`grid`),d=(0,Ce.useId)(),f=u===`grid`||!i,p=f?(0,O.jsx)(`span`,{id:u===`grid`?d:void 0,className:r===void 0?void 0:`help-name`,tabIndex:r===void 0?void 0:0,style:ye(c,{help:r!==void 0,disabled:a}),children:n}):null,m=r===void 0?p:(0,O.jsx)(v,{content:r,children:p}),h=r===void 0||f?t:(0,O.jsx)(v,{content:r,children:t});if(u===`grid`){let e=l?.nameWidth??ve(c);return(0,O.jsxs)(`div`,{role:`group`,"aria-labelledby":d,"data-testid":o,style:_e(c,e),children:[m,(0,O.jsx)(`span`,{style:xe,children:h})]})}return s===`above`?(0,O.jsxs)(`div`,{"data-testid":o,style:be(c),children:[m,h]}):(0,O.jsxs)(`div`,{"data-testid":o,style:ge(c),children:[m,h]})}var Ce,O;function k(){return(k=e((()=>{Ce=t(),_(),w(),E(),b(),O=n(),D.__docgenInfo={description:`A name, its help, and the control they belong to.
...
@default undefined — nothing of its own happens`},testId:{required:!1,tsType:{name:`string`},description:"Value of the `data-testid` attribute.\n@default undefined"}}}})))()}function ze(e){let{children:t,placement:n,label:r,icon:i,padded:a=!0}=e,{metrics:o}=x(),[s,c]=(0,Be.useState)(!1);return(0,j.jsx)(m,{placement:Ve[n],onInteraction:e=>c(e),content:a?(0,j.jsx)(`div`,{style:oe(o),children:t}):(0,j.jsx)(j.Fragment,{children:t}),children:(0,j.jsx)(Pe,{icon:i,label:r,active:s,opensMenu:!0})})}var Be,j,Ve;function He(){return(He=e((()=>{p(),Be=t(),Re(),S(),b(),j=n(),Ve={"top-left":`bottom-start`,"top-right":`bottom-end`,"bottom-left":`top-start`,"bottom-right":`top-end`,above:`bottom-end`,below:`top-end`,stretch:`bottom-end`},ze.__docgenInfo={description:`The button at the end of a bar, and the panel behind it.
...
@default true`}}}})))()}function Ue(e){let{children:t,end:n,tools:r,info:i,more:a,placement:o,label:s}=e,{moreIcon:c,morePadded:l,folded:u,testId:d,restingOpacity:f}=e,{metrics:p,awake:m,busy:h}=x(),g=u||a!==void 0?(0,M.jsxs)(ze,{placement:o,label:s,icon:c,padded:l,children:[u?t:null,a]}):null;return(0,M.jsxs)(`div`,{style:ae(o,p),"data-testid":d,children:[(0,M.jsx)(`div`,{style:re(m?1:ne(f),h)}),u?(0,M.jsx)(`div`,{style:ee(p),children:g}):(0,M.jsxs)(`div`,{role:`group`,"aria-label":s,style:ee(p),children:[t,n,r,i,g]})]})}var M;function We(){return(We=e((()=>{He(),S(),b(),M=n(),Ue.__docgenInfo={description:`The small card of controls floating in a corner of a figure.
...
@default true`},testId:{required:!1,tsType:{name:`string`},description:"Value of the `data-testid` attribute of the card, for the end-to-end tests.\n@default undefined"}}}})))()}function tt(e,t){return{display:`block`,maxWidth:`100%`,padding:`${e.paddingY}px ${e.paddingX}px`,color:t===`strong`?`var(--text)`:`var(--text-muted)`,fontSize:e.labelSize,fontWeight:t===`strong`?600:400,lineHeight:1.35,textWrap:`pretty`}}function nt(e){return{position:`relative`,display:`flex`,flexDirection:`column`,gap:Math.max(2,e.gap-4),padding:`${e.paddingY}px ${e.paddingX}px`,color:`var(--text)`,fontSize:e.labelSize,lineHeight:1.3}}function rt(e){return{marginBottom:2,color:`var(--text-muted)`,fontSize:e.labelSize,fontWeight:600,whiteSpace:`nowrap`}}function it(e){return{position:`absolute`,zIndex:2,display:`flex`,flexDirection:`column`,gap:2,maxWidth:280,padding:`${e.paddingY}px ${e.paddingX}px`,borderRadius:`var(--radius)`,border:`1px solid var(--border)`,background:`var(--surface)`,boxShadow:`var(--shadow-md)`,color:`var(--text)`,fontSize:e.labelSize,lineHeight:1.35,pointerEvents:`none`}}var at;function F(){return(F=e((()=>{at={display:`inline-flex`,alignItems:`center`,gap:6,border:`none`,background:`none`,color:`inherit`,font:`inherit`,padding:0,textAlign:`left`}})))()}function ot(e){let{children:t,placement:n=`over`,edge:r=`bottom`}=e,{tone:i=`quiet`,live:a=!1}=e,{metrics:o}=x();return(0,ct.jsx)(`div`,{style:n===`below`?dt:st(r,o),children:(0,ct.jsx)(`span`,{style:tt(o,i),"aria-live":a?`polite`:void 0,"aria-atomic":a?!0:void 0,children:t})})}function st(e,t){return{position:`absolute`,left:0,right:0,top:e===`top`?0:void 0,bottom:e===`bottom`?0:void 0,display:`flex`,alignItems:`center`,padding:`${t.paddingY}px ${t.inset}px`,background:`linear-gradient(to ${e===`bottom`?`top`:`bottom`}, ${lt}, ${lt} 45%, ${ut})`,pointerEvents:`none`}}var ct,lt,ut,dt;function ft(){return(ft=e((()=>{F(),b(),ct=n(),lt=`color-mix(in srgb, var(--surface) 86%, transparent)`,ut=`color-mix(in srgb, var(--surface) 0%, transparent)`,dt={display:`flex`,alignItems:`center`},ot.__docgenInfo={description:`The band across a figure that says, in one sentence, what it is showing.
...
@default 'row'`}}}})))()}function Kt(e){let{children:t,label:n=`What am I looking at?`}=e,{placement:r=`bottom-end`,testId:i}=e,{metrics:a}=x(),[o,s]=(0,Jt.useState)(!1);return(0,Yt.jsx)(m,{placement:r,onInteraction:e=>s(e),content:(0,Yt.jsx)(`div`,{style:qt(a),children:t}),children:(0,Yt.jsx)(Pe,{icon:`help`,label:n,active:o,testId:i,opensMenu:!0})})}function qt(e){return{maxWidth:320,padding:`${e.paddingY+4}px ${e.paddingX+4}px`,color:`var(--text)`,fontSize:e.labelSize+1,lineHeight:1.4,textWrap:`pretty`}}var Jt,Yt;function Xt(){return(Xt=e((()=>{p(),Jt=t(),Re(),b(),Yt=n(),Kt.__docgenInfo={description:`The question mark that hands the figure's own explanation back on request.
...
@default 'bottom-end'`},testId:{required:!1,tsType:{name:`string`},description:"Value of the `data-testid` attribute of the glyph.\n@default undefined"}}}})))()}function Zt(e){return e===`dot`||e===`square`}var Qt;function $t(){return($t=e((()=>{Qt=[`dot`,`ring`,`square`,`line`,`dashed`,`cross`]})))()}function en(e){let{color:t,shape:n=`dot`,size:r=12,muted:i=!1}=e,a=Zt(n);return(0,H.jsx)(`svg`,{width:r,height:r,viewBox:`0 0 12 12`,"aria-hidden":`true`,focusable:`false`,style:{display:`block`,flex:`none`,opacity:i?nn:1},children:(0,H.jsx)(`g`,{fill:a?t:`none`,stroke:a?`none`:t,strokeLinecap:`round`,children:tn[n]})})}var H,tn,nn;function rn(){return(rn=e((()=>{$t(),H=n(),tn={dot:(0,H.jsx)(`circle`,{cx:`6`,cy:`6`,r:`4.2`}),ring:(0,H.jsx)(`circle`,{cx:`6`,cy:`6`,r:`3.4`,strokeWidth:`2.2`}),square:(0,H.jsx)(`rect`,{x:`2`,y:`2`,width:`8`,height:`8`,rx:`1.5`}),line:(0,H.jsx)(`line`,{x1:`0.5`,y1:`6`,x2:`11.5`,y2:`6`,strokeWidth:`2.8`}),dashed:(0,H.jsx)(`line`,{x1:`0.5`,y1:`6`,x2:`11.5`,y2:`6`,strokeWidth:`2.8`,strokeDasharray:`3.4 2.6`}),cross:(0,H.jsx)(`path`,{d:`M2.2 2.2 L9.8 9.8 M9.8 2.2 L2.2 9.8`,strokeWidth:`2.4`})},nn=.35,en.__docgenInfo={description:`The small picture of a mark, in front of what the mark means.
...
@default false`}}}})))()}function an(e){let{title:t,entries:n,placement:r=`bottom-left`,onToggle:i,maxEntries:a=8,testId:o}=e,{metrics:s,awake:c,busy:l}=x(),u=(0,ln.useId)(),d=Math.max(1,a),f=n.length>d?n.length-(d-1):0,p=f===0?n:n.slice(0,d-1);return(0,U.jsxs)(`div`,{style:ae(r,s),"data-testid":o,children:[(0,U.jsx)(`div`,{style:re(c?1:un,l)}),(0,U.jsxs)(`div`,{role:`group`,"aria-labelledby":u,style:nt(s),children:[(0,U.jsx)(`div`,{id:u,style:rt(s),children:t}),p.map(e=>(0,U.jsx)(on,{entry:e,onToggle:i},e.id)),f===0?null:(0,U.jsx)(`span`,{style:cn(s),children:`+ ${f} more`})]})]})}function on(e){let{entry:t,onToggle:n}=e,r=t.muted??!1,i={...at,alignItems:t.note===void 0?`center`:`flex-start`},a=(0,U.jsxs)(U.Fragment,{children:[(0,U.jsx)(en,{color:t.color,shape:t.shape,muted:r}),(0,U.jsxs)(`span`,{style:dn,children:[(0,U.jsx)(`span`,{style:r?pn:fn,children:sn(t)}),t.note===void 0?null:(0,U.jsx)(`span`,{style:mn,children:t.note})]})]});return n===void 0?(0,U.jsx)(`span`,{style:i,children:a}):(0,U.jsx)(`button`,{type:`button`,"aria-pressed":!r,style:{...i,cursor:`pointer`},onClick:()=>{n(t.id)},children:a})}function sn(e){return e.count===void 0?e.label:`${e.label} (${e.count.toLocaleString()})`}function cn(e){return{color:`var(--text-muted)`,paddingLeft:e.gap+12}}var ln,U,un,dn,fn,pn,mn;function hn(){return(hn=e((()=>{ln=t(),rn(),F(),S(),b(),U=n(),un=.74,dn={display:`inline-flex`,flexDirection:`column`,gap:1,minWidth:0},fn={color:`var(--text)`},pn={color:`var(--text-faint)`,textDecoration:`line-through`},mn={color:`var(--text-faint)`,fontSize:`0.9em`},an.__docgenInfo={description:`The card that says what colour and shape mean on a figure.
...
@default undefined`},maxEntries:{required:!1,tsType:{name:`number`},description:"The most entries written before the rest fold into `+ 7 more`.\n@default 8"},testId:{required:!1,tsType:{name:`string`},description:"Value of the `data-testid` attribute of the card.\n@default undefined"}}}})))()}function gn(e){return{display:`inline-flex`,alignItems:`center`,gap:0,height:e.controlHeight,padding:2,borderRadius:e.controlRadius,background:`var(--surface-sunken)`}}function _n(e,t){let n=e.controlHeight-4;return{display:`inline-flex`,alignItems:`center`,justifyContent:`center`,width:n,height:n,padding:0,border:`none`,borderRadius:Math.max(3,e.controlRadius-2),background:`transparent`,color:t?`var(--text-faint)`:`var(--text-muted)`,font:`inherit`,fontSize:e.fontSize+1,lineHeight:1,cursor:t?`default`:`pointer`,opacity:t?.45:1}}function vn(e,t){return{minWidth:Math.max(e.fontSize,Math.ceil(t*e.fontSize*yn)),padding:`0 3px`,color:`var(--text)`,fontSize:e.fontSize,fontVariantNumeric:`tabular-nums`,textAlign:`center`,userSelect:`none`}}var yn;function bn(){return(bn=e((()=>{yn=.6})))()}function xn(e){let{value:t,min:n,max:r,onChange:i,label:a,help:o,hideLabel:s=!1,disabled:c=!1,testId:l,step:u=1,digits:d=0,unit:f=``}=e,{metrics:p}=x();function m(e){let a=Cn(t+e*u,n,r);a!==t&&i(a)}function h(e){let t=Tn.get(e.key);t===void 0||c||(e.preventDefault(),m(t))}return(0,W.jsx)(D,{label:a,help:o,hideLabel:s,disabled:c,children:(0,W.jsxs)(`span`,{style:gn(p),"data-testid":l,children:[(0,W.jsx)(`button`,{type:`button`,style:_n(p,c||t<=n),disabled:c||t<=n,"aria-label":`Decrease ${a}`,onClick:()=>m(-1),onKeyDown:h,children:`−`}),(0,W.jsx)(`span`,{style:vn(p,Sn(e)),"aria-live":`polite`,children:`${t.toFixed(d)}${f}`}),(0,W.jsx)(`button`,{type:`button`,style:_n(p,c||t>=r),disabled:c||t>=r,"aria-label":`Increase ${a}`,onClick:()=>m(1),onKeyDown:h,children:`+`})]})})}function Sn(e){let{min:t,max:n,digits:r=0,unit:i=``}=e;return Math.max(t.toFixed(r).length,n.toFixed(r).length)+i.length}function Cn(e,t,n){let r=Math.round(e*wn)/wn;return r<t?t:r>n?n:r}var W,wn,Tn;function En(){return(En=e((()=>{k(),bn(),b(),W=n(),wn=1e10,Tn=new Map([[`ArrowUp`,1],[`ArrowRight`,1],[`ArrowDown`,-1],[`ArrowLeft`,-1]]),xn.__docgenInfo={description:`A value the reader nudges up and down.
...
@default 0`},unit:{required:!1,tsType:{name:`string`},description:"Written after the value, e.g. `px`.\n@default '' — no unit is written"}}}})))()}function Dn(e){let{title:t,children:n,onReset:r,resetLabel:i=`Reset`,help:a}=e,{actions:o,hint:s=On,nameWidth:c,testId:l}=e,{metrics:u}=x(),d=(0,G.useId)(),[f,p]=(0,G.useState)(!1),m=c??ve(u),h=(0,G.useMemo)(()=>({nameWidth:m}),[m]);return(0,K.jsxs)(`div`,{role:`group`,"aria-labelledby":d,"data-testid":l,style:jt(u),children:[(0,K.jsxs)(`div`,{style:Mt(u),children:[(0,K.jsxs)(`span`,{style:Nt(u),children:[(0,K.jsx)(`span`,{id:d,children:t}),a===void 0?null:(0,K.jsx)(le,{content:a,size:u.fontSize})]}),r===void 0?null:(0,K.jsx)(`button`,{type:`button`,style:Pt(u,f),onClick:r,onPointerEnter:()=>p(!0),onPointerLeave:()=>p(!1),onFocus:()=>p(!0),onBlur:()=>p(!1),children:i})]}),(0,K.jsxs)(`div`,{style:Ft(u),children:[(0,K.jsx)(he.Provider,{value:h,children:n}),s===``?null:(0,K.jsx)(`p`,{style:It(u),children:s})]}),o===void 0?null:(0,K.jsx)(`div`,{style:Lt(u),children:o})]})}var G,K,On;function kn(){return(kn=e((()=>{G=t(),ce(),w(),Vt(),E(),b(),K=n(),On=`Hover a name for what it does.`,Dn.__docgenInfo={description:`The settings behind a figure's cog.
...
@default derived from the type size — 88 at the compact size`},testId:{required:!1,tsType:{name:`string`},description:"Value of the `data-testid` attribute of the panel.\n@default undefined"}}}})))()}function An(e,t){de({key:jn[e.key]??e.key,target:e.target,preventDefault:()=>e.preventDefault()},t)}var jn;function Mn(){return(Mn=e((()=>{ue(),jn={ArrowLeft:`ArrowUp`,ArrowRight:`ArrowDown`}})))()}function Nn(e,t=`strip`){return{boxSizing:`border-box`,display:`inline-flex`,alignItems:`center`,gap:zn,height:In(e,t),padding:q,borderRadius:Ln(e),background:`var(--surface-sunken)`}}function Pn(e,t){let{selected:n,disabled:r=!1,size:i=`strip`}=t;return{boxSizing:`border-box`,display:`inline-flex`,alignItems:`center`,justifyContent:`center`,gap:4,height:In(e,i)-q*2,padding:`0 ${Rn(e,i)}px`,border:`none`,borderRadius:Ln(e)-q,background:n?`var(--surface)`:`transparent`,color:n?`var(--text)`:`var(--text-muted)`,boxShadow:n?`var(--shadow-sm)`:void 0,font:`inherit`,fontSize:e.fontSize,fontWeight:n?600:500,lineHeight:1,whiteSpace:`nowrap`,cursor:r?`default`:`pointer`,opacity:r?.6:1}}function Fn(e,t){return{fontSize:Math.max(9,e.labelSize-1),fontVariantNumeric:`tabular-nums`,fontWeight:500,opacity:t?.85:.75}}function In(e,t){return t===`strip`?e.controlHeight:Math.max(20,e.controlHeight-4)}function Ln(e){return e.controlRadius+2}function Rn(e,t){return t===`strip`?e.paddingX+2:e.paddingX}var q,zn;function Bn(){return(Bn=e((()=>{q=2,zn=2})))()}function Vn(e){let{value:t,options:n,onChange:r,label:i,role:a=`tablist`}=e,{panelId:o,baseId:s,size:c=`strip`,disabled:l=!1,testId:u}=e,{metrics:d}=x(),f=(0,Hn.useId)(),p=(0,Hn.useRef)([]),m=a===`tablist`,h=s??f,g=-1;for(let e=0;e<n.length;e++)n[e]?.value===t&&(g=e);return(0,J.jsx)(`div`,{role:a,"aria-label":i,"data-testid":u,style:Nn(d,c),onKeyDown:e=>{An(e,{length:n.length,selectedIndex:g,onSelect:e=>{let t=n[e];t!==void 0&&t.disabled!==!0&&(p.current[e]?.focus(),r(t.value))}})},children:n.map((e,n)=>{let i=e.value===t,a=l||e.disabled===!0;return(0,J.jsxs)(`button`,{ref:e=>{p.current[n]=e},type:`button`,role:m?`tab`:`radio`,id:m?`${h}-${e.value}`:void 0,"aria-selected":m?i:void 0,"aria-checked":m?void 0:i,"aria-controls":m?o:void 0,title:e.title,disabled:a,tabIndex:n===Math.max(g,0)?0:-1,style:Pn(d,{selected:i,disabled:a,size:c}),onClick:()=>r(e.value),children:[e.label,e.count===void 0?null:(0,J.jsx)(`span`,{style:Fn(d,i),children:e.count})]},e.value)})})}var Hn,J;function Un(){return(Un=e((()=>{Hn=t(),Mn(),Bn(),b(),J=n(),Vn.__docgenInfo={description:`A row of choices in a sunken track, the one in force lifted out of it.
...
@default false`},testId:{required:!1,tsType:{name:`string`},description:"Value of the `data-testid` attribute of the group.\n@default undefined"}}}})))()}function Wn(e){let{pointerX:t,pointerY:n,cardWidth:r,cardHeight:i,boxWidth:a,boxHeight:o,offset:s=Kn}=e,c=t+s+r>a,l=n+s+i>o;return{left:Gn(c?t-s-r:t+s,a-r),top:Gn(l?n-s-i:n+s,o-i),flippedX:c,flippedY:l}}function Gn(e,t){return Number.isFinite(e)?Math.max(0,Math.min(e,Number.isFinite(t)?Math.max(0,t):0)):0}var Kn;function qn(){return(qn=e((()=>{Kn=14})))()}function Jn(e){let{x:t,y:n,boxWidth:r,boxHeight:i,title:o,rows:s,maxRows:c=12,pinned:l=!1,onUnpin:u,testId:d}=e,{metrics:f}=x(),p=(0,Qn.useRef)(null),m=fe(p),h=Math.max(1,c),g=l?0:Math.max(0,s.length-h),_=g===0?s:s.slice(0,h),v=_.length+(g===0?1:2),y=Wn({pointerX:t,pointerY:n,cardWidth:m.width>0?m.width:$n,cardHeight:m.height>0?m.height:Xn(v),boxWidth:r,boxHeight:i});return(0,Y.jsxs)(`div`,{ref:p,"data-testid":d,role:l?`group`:`tooltip`,"aria-label":l?o:void 0,style:{...it(f),left:y.left,top:y.top,...l?Zn(i,f):null},children:[(0,Y.jsxs)(`div`,{style:rr,children:[(0,Y.jsx)(`span`,{children:o}),l&&u!==void 0?(0,Y.jsx)(a,{variant:`minimal`,size:`small`,icon:`cross`,"aria-label":`Dismiss`,onClick:u}):null]}),Yn(_),g===0?null:(0,Y.jsx)(`div`,{style:cr,children:`+ ${g} more — click to keep this open`})]})}function Yn(e){let t=[],n=new Map;for(let r of e){let e=n.get(r.label)??0;n.set(r.label,e+1),t.push((0,Y.jsxs)(`div`,{style:ir,children:[r.color===void 0?null:(0,Y.jsx)(`span`,{style:{...sr,background:r.color}}),(0,Y.jsx)(`span`,{style:ar,children:r.label}),(0,Y.jsx)(`span`,{style:or,children:r.value})]},e===0?r.label:`${r.label} ${String(e)}`))}return t}function Xn(e){return tr+e*er}function Zn(e,t){return{pointerEvents:`auto`,userSelect:`text`,maxHeight:Math.max(nr,e-t.inset*2),overflowY:`auto`}}var Qn,Y,$n,er,tr,nr,rr,ir,ar,or,sr,cr;function lr(){return(lr=e((()=>{Qn=t(),o(),pe(),qn(),F(),b(),Y=n(),$n=220,er=18,tr=16,nr=80,rr={display:`flex`,alignItems:`center`,justifyContent:`space-between`,gap:8,fontWeight:600},ir={display:`flex`,alignItems:`baseline`,gap:6},ar={color:`var(--text-muted)`},or={marginLeft:`auto`,fontVariantNumeric:`tabular-nums`,whiteSpace:`nowrap`},sr={alignSelf:`center`,flex:`none`,width:8,height:8,borderRadius:2},cr={marginTop:2,paddingTop:2,borderTop:`1px solid var(--border)`,color:`var(--text-faint)`},Jn.__docgenInfo={description:`The card that follows the pointer and says everything known about the mark
under it.
...
@default undefined`},testId:{required:!1,tsType:{name:`string`},description:"Value of the `data-testid` attribute of the card.\n@default undefined"}}}})))()}function ur(e){let{value:t,options:n,onChange:r,label:i,help:a,hideLabel:o=!1,disabled:s=!1,testId:c}=e;return(0,dr.jsx)(D,{label:i,help:a,hideLabel:o,disabled:s,children:(0,dr.jsx)(Vn,{role:`radiogroup`,size:`setting`,label:i,value:t,options:n,disabled:s,testId:c,onChange:r})})}var dr;function fr(){return(fr=e((()=>{Un(),k(),dr=n(),ur.__docgenInfo={description:`The row of segments a card uses while every choice still fits on one line.
...
is the ragged panel the grid exists to prevent.
@default false`},disabled:{required:!1,tsType:{name:`boolean`},description:`Whether the control is greyed and unreachable.
@default false`},testId:{required:!1,tsType:{name:`string`},description:"Value of the `data-testid` attribute of the control.\n@default undefined"},value:{required:!0,tsType:{name:`TValue`},description:`The current choice.`},options:{required:!0,tsType:{name:`ReadonlyArray`,elements:[{name:`OverlayOption`,elements:[{name:`TValue`}],raw:`OverlayOption<TValue>`}],raw:`ReadonlyArray<OverlayOption<TValue>>`},description:`What may be chosen, in the order offered.`},onChange:{required:!0,tsType:{name:`signature`,type:`function`,raw:`(value: TValue) => void`,signature:{arguments:[{type:{name:`TValue`},name:`value`}],return:{name:`void`}}},description:`Called with the new choice.`}}}})))()}function pr(e){let{label:t,value:n,keyWord:r=t,showKey:a=!0,swatches:o}=e,{active:s=!1,disabled:c=!1,disabledReason:l}=e,{opensMenu:u=!1,onClick:d,testId:f}=e,{metrics:p}=x(),[m,h]=(0,hr.useState)(!1),[g,_]=(0,hr.useState)(!1),v=`${t} — ${n}`;return(0,X.jsxs)(`button`,{type:`button`,title:c&&l!==void 0?l:v,"aria-label":v,"aria-haspopup":u?`menu`:void 0,"aria-expanded":u?s:void 0,disabled:c,"data-testid":f,style:yt(p,{hovered:m,focused:g,active:s,disabled:c}),onClick:d,onPointerEnter:()=>h(!0),onPointerLeave:()=>h(!1),onFocus:()=>_(!0),onBlur:()=>_(!1),children:[o===void 0||o.length===0?null:(0,X.jsx)(pt,{colors:o}),a?(0,X.jsx)(`span`,{style:St(),children:r}):null,(0,X.jsx)(`span`,{style:xt(),children:n}),(0,X.jsx)(`span`,{"aria-hidden":`true`,style:wt(),children:(0,X.jsx)(i,{icon:`caret-down`,size:mr(p.fontSize)})})]})}function mr(e){return e+2}var hr,X;function gr(){return(gr=e((()=>{r(),hr=t(),L(),b(),Et(),X=n(),pr.__docgenInfo={description:`A setting written as its own value, with a caret saying it can be changed.
...
@default false`},onClick:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:`Called when it is pressed. Leave it out inside a popover, which listens on
the wrapper it puts around the button and would otherwise be told twice.
@default undefined — nothing of its own happens`},testId:{required:!1,tsType:{name:`string`},description:"Value of the `data-testid` attribute.\n@default undefined"}}}})))()}function _r(e){let{label:t,value:n,options:r,onChange:i,keyWord:a,showKey:o}=e,{swatches:s,disabled:c=!1,disabledReason:l}=e,{placement:u=`bottom-end`,testId:p}=e,{metrics:h}=x(),_=(0,vr.useId)(),[v,y]=(0,vr.useState)(!1),ee=n;for(let e of r)e.value===n&&(ee=e.label);return(0,Z.jsx)(m,{isOpen:v,disabled:c,placement:u,onInteraction:e=>y(e),content:(0,Z.jsxs)(d,{role:`listbox`,"aria-labelledby":_,size:h.blueprintSize,style:yr,children:[(0,Z.jsx)(g,{title:t,titleId:_}),r.map(e=>(0,Z.jsx)(f,{roleStructure:`listoption`,selected:e.value===n,text:e.label,htmlTitle:e.title,disabled:e.disabled,onClick:()=>i(e.value)},e.value))]}),children:(0,Z.jsx)(pr,{label:t,value:ee,keyWord:a,showKey:o,swatches:s,active:v,disabled:c,disabledReason:l,testId:p,opensMenu:!0})})}var vr,Z,yr;function br(){return(br=e((()=>{l(),h(),u(),p(),vr=t(),gr(),b(),Z=n(),yr={minWidth:168},_r.__docgenInfo={description:`A setting written as its value, whose choices are a menu behind it.
...
@default undefined`}}}})))()}export{ot as A,D as B,Kt as C,Dt as D,Gt as E,Re as F,A as I,De as L,Ze as M,et as N,At as O,Pe as P,we as R,$t as S,Ht as T,k as V,En as _,_r as a,rn as b,ur as c,lr as d,Vn as f,xn as g,kn as h,Sr as i,ft as j,L as k,fr as l,Dn as m,Ar as n,br as o,Un as p,xr as r,gr as s,kr as t,Jn as u,an as v,Xt as w,Qt as x,hn as y,Ee as z};