import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{n as t}from"./iframe-BN1WVCbH.js";import{i as n,n as r,r as i,t as a}from"./headerButton-BV1ib8dS.js";import{i as o,r as s}from"./marks-DF2ZmKQi.js";import{n as c,t as l}from"./EcosystemMenu-CWQHQhRg.js";function u(e){let{currentSiteId:t,label:n=`Tools`,...r}=e;return(0,d.jsx)(i,{...r,className:`ecosystem-button`,icon:`grid-view`,label:n,menu:(0,d.jsx)(l,{currentSiteId:t})})}var d;function f(){return(f=e((()=>{n(),c(),d=t(),u.__docgenInfo={description:`The Tools entry of a site header: one button opening every other site of the
...
| 'lcao'
| 'regexp'
| 'pdb'`,elements:[{name:`literal`,value:`'inchi'`},{name:`literal`,value:`'vcl'`},{name:`literal`,value:`'smiles'`},{name:`literal`,value:`'chemcalc'`},{name:`literal`,value:`'nmrium'`},{name:`literal`,value:`'surge'`},{name:`literal`,value:`'tex'`},{name:`literal`,value:`'lcao'`},{name:`literal`,value:`'regexp'`},{name:`literal`,value:`'pdb'`}]},description:`The site this button sits on, which is shown but never linked.
