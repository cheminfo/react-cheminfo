import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{n as t}from"./iframe-CsLeyY0n.js";import{n,t as r}from"./lookup-Ba1XjkcU.js";function i(e){let t=n(e),r=a(t),i=[`--brand: ${t.brand};`,`--brand-alt: ${r};`];return t.brandAlt!==r&&i.push(`--brand-alt-text: ${t.brandAlt};`),i.push(`--accent: var(--brand);`),`:root {\n  ${i.join(`
