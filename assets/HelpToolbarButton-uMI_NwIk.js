import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{n as t}from"./iframe-DqpBrNIF.js";import{n,r}from"./buttons-Dfx_Jez3.js";import{n as i,t as a}from"./HelpTooltip-DRLxJKsY.js";function o(e){let{content:t,onClick:r,label:i,icon:o=`help`,small:c=!1,className:l}=e;return(0,s.jsx)(a,{content:t,placement:`bottom`,children:(0,s.jsx)(n,{variant:`minimal`,size:c?`small`:`medium`,icon:o,text:i,"aria-label":i??t.title,className:l,onClick:r})})}var s;function c(){return(c=e((()=>{r(),i(),s=t(),o.__docgenInfo={description:`The help entry of a toolbar: a glyph that explains itself on hover and opens
