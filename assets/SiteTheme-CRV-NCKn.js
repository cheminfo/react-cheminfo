import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{n as t}from"./iframe-D72pBctd.js";import{n,t as r}from"./lookup-h4-Yw8WY.js";function i(e){let t=n(e),r=a(t),i=[`--brand: ${t.brand};`,`--brand-alt: ${r};`];return t.brandAlt!==r&&i.push(`--brand-alt-text: ${t.brandAlt};`),i.push(`--accent: var(--brand);`),`:root {\n  ${i.join(`
