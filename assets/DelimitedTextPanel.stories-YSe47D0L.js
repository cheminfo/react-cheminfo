import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{n as t}from"./iframe-CsLeyY0n.js";import{n,r,t as i}from"./moleculeTable-CmKVt629.js";import{n as a,t as o}from"./DelimitedTextPanel-CjvDl3nk.js";var s,c,l,u,d,f,p,m;function h(){return(h=e((()=>{a(),r(),s=t(),c={title:`Delimited/DelimitedTextPanel`,component:o,args:{rows:n,header:i,fileName:`molecules`},argTypes:{defaultDelimiter:{control:`inline-radio`,options:[`tab`,`comma`,`semicolon`]},downloadable:{control:`boolean`},fileName:{control:`text`},label:{control:`text`},height:{control:{type:`range`,min:120,max:480,step:20}}},parameters:{layout:`padded`,docs:{description:{component:`A whole table as text: read it, switch the separator, then copy it or save it. Every cell is escaped for the separator in force, so what a spreadsheet opens holds the columns the page shows.`}}},render:e=>(0,s.jsx)(`div`,{style:{width:`min(46rem, 92vw)`},children:(0,s.jsx)(o,{...e})})},l={},u={args:{defaultDelimiter:`comma`}},d={args:{defaultDelimiter:`semicolon`}},f={args:{description:`Five compounds, with the monoisotopic mass of the neutral molecule.`}},p={args:{downloadable:!1,height:200}},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{}`,...l.parameters?.docs?.source},description:{story:`Tab separated: only the two notes holding a quote have to be escaped.`,...l.parameters?.docs?.description}}},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  args: {
