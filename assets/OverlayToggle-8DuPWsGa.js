import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{h as t,n}from"./iframe-DzkT2GF_.js";import{n as r,t as i}from"./icon-CCl7BR5X.js";import{n as a,t as o}from"./useT-SaARZZCl.js";import{o as s,t as c}from"./components-CuIpHKEK.js";import{n as l,t as u}from"./htmlSelect-UTWJo5gh.js";import{i as d,n as f,r as p,t as m}from"./menuItem-_W865Xsz.js";import{i as h,r as g}from"./popoverNextMigrationUtils-COPa16Fm.js";import{n as _,t as v}from"./menuDivider-BAQcSnzg.js";import{T as y,_ as b,a as ee,c as te,f as ne,m as re,o as ie,p as ae,s as oe,v as x,w as S}from"./OverlaySegmented-BB8kjyRu.js";import{i as C,n as w}from"./overlaySurface-DHur7bpc.js";import{t as se}from"./clamp-M7_x50VL.js";import{a as ce,t as T}from"./numbers-BxzU8aH2.js";import{n as le,t as ue}from"./roundTo-BbWJSCmm.js";import{a as E,c as de,d as fe,f as pe,i as me,l as he,o as ge,r as _e,s as ve,u as ye}from"./OverlayLayer-BRwnVcvf.js";import{n as be,r as xe,s as Se,t as Ce}from"./OverlayIconButton-D3DTzGoi.js";function we(e,t){return!Number.isFinite(e)||e<=0||!Number.isFinite(t)?!1:e<t}function Te(e){let{collapsed:t,startedFolded:n,width:r,collapseBelow:i}=e;return t??(n||we(r,i))}function D(e){let{children:t,placement:n,label:r,icon:i,padded:a=!0}=e,{metrics:o}=C(),[s,c]=(0,O.useState)(!1);return(0,k.jsx)(g,{placement:A[n],onInteraction:e=>c(e),content:a?(0,k.jsx)(`div`,{style:fe(o),children:t}):(0,k.jsx)(k.Fragment,{children:t}),children:(0,k.jsx)(Ce,{icon:i,label:r,active:s,opensMenu:!0})})}var O,k,A;function j(){return(j=e((()=>{h(),O=t(),be(),E(),w(),k=n(),A={"top-left":`bottom-start`,"top-right":`bottom-end`,"bottom-left":`top-start`,"bottom-right":`top-end`,above:`bottom-end`,below:`top-end`,stretch:`bottom-end`},D.__docgenInfo={description:`The button at the end of a bar, and the panel behind it.
...
@default undefined — the bar carries no tools`},info:{required:!1,tsType:{name:`ReactNode`},description:`The one control that never folds.
@default undefined — the bar carries no glyph`},more:{required:!1,tsType:{name:`ReactNode`},description:`What waits behind the button.
@default undefined — nothing but whatever has folded away`},placement:{required:!0,tsType:{name:`union`,raw:`OverlayCorner | 'above' | 'below' | 'stretch'`,elements:[{name:`union`,raw:`'top-left' | 'top-right' | 'bottom-left' | 'bottom-right'`,elements:[{name:`literal`,value:`'top-left'`},{name:`literal`,value:`'top-right'`},{name:`literal`,value:`'bottom-left'`},{name:`literal`,value:`'bottom-right'`}]},{name:`literal`,value:`'above'`},{name:`literal`,value:`'below'`},{name:`literal`,value:`'stretch'`}]},description:`Where the bar sits.`},label:{required:!0,tsType:{name:`string`},description:`What the group of controls is called.`},moreIcon:{required:!0,tsType:{name:`IconName`},description:`Glyph of the button that opens the rest.`},morePadded:{required:!0,tsType:{name:`boolean`},description:`Whether that button's panel is drawn with the card's own padding.`},folded:{required:!0,tsType:{name:`boolean`},description:`Whether the bar has folded its controls away behind that button.`},testId:{required:!1,tsType:{name:`string`},description:"Value of the `data-testid` attribute of the bar.\n@default undefined"}}}})))()}function Ee(e){let{children:t,end:n,tools:r,info:i,more:o}=e,{placement:s=`top-right`}=e,{label:c,restingOpacity:l=me}=e,u=a(),d=c??u(`overlay.options`),{collapsed:f,defaultCollapsed:p=!1}=e,{collapseBelow:m=420,moreIcon:h=`cog`,testId:g}=e,{morePadded:_=!0}=e,{width:v}=C(),[y]=(0,De.useState)(p),b=Te({collapsed:f,startedFolded:y,width:v,collapseBelow:m});return s===`stretch`?(0,R.jsx)(F,{end:n,tools:r,info:i,more:o,placement:s,label:d,moreIcon:h,morePadded:_,folded:b,testId:g,children:t}):(0,R.jsx)(M,{end:n,tools:r,info:i,more:o,placement:s,label:d,moreIcon:h,morePadded:_,folded:b,restingOpacity:l,testId:g,children:t})}var De,R;function Oe(){return(Oe=e((()=>{De=t(),o(),P(),L(),E(),w(),R=n(),Ee.__docgenInfo={description:`The controls of a figure: a small card floating in one of its corners, or
...
@default true`},testId:{required:!1,tsType:{name:`string`},description:"Value of the `data-testid` attribute of the card, for the end-to-end tests.\n@default undefined"}}}})))()}function z(e){let{colors:t}=e,{metrics:n}=C(),r=t.length>V?V-1:t.length,i=t.length-r,a=je(n),o=[];for(let e=0;e<r;e++){let n=t[e];n!==void 0&&o.push((0,B.jsx)(`span`,{style:ke(n,a)},`${e}:${n}`))}return(0,B.jsxs)(`span`,{"aria-hidden":`true`,style:Me,children:[o,i>0?(0,B.jsx)(`span`,{style:Ae(n),children:`+${i}`}):null]})}function ke(e,t){return{display:`inline-block`,width:t,height:t,borderRadius:`50%`,background:e,boxShadow:t>=6?`inset 0 0 0 1px var(--border)`:void 0}}function Ae(e){return{fontSize:Math.max(9,e.labelSize-1),fontVariantNumeric:`tabular-nums`,fontWeight:600,lineHeight:1}}function je(e){return Math.max(4,Math.round(e.buttonSize/6))}var B,V,Me;function H(){return(H=e((()=>{w(),B=n(),V=4,Me={display:`inline-flex`,alignItems:`center`,gap:2},z.__docgenInfo={description:`The colours of a figure, as the glyph of the control that changes them.
...
reader recognises the plot in it without being taught anything.`}}}})))()}function Ne(e){return{display:`inline-flex`,alignItems:`center`,gap:0,height:e.controlHeight,padding:2,borderRadius:e.controlRadius,background:`var(--surface-sunken)`}}function Pe(e,t){let n=e.controlHeight-4;return{display:`inline-flex`,alignItems:`center`,justifyContent:`center`,width:n,height:n,padding:0,border:`none`,borderRadius:Math.max(3,e.controlRadius-2),background:`transparent`,color:t?`var(--text-faint)`:`var(--text-muted)`,font:`inherit`,fontSize:e.fontSize+1,lineHeight:1,cursor:t?`default`:`pointer`,opacity:t?.45:1}}function Fe(e,t){return{minWidth:Math.max(e.fontSize,Math.ceil(t*e.fontSize*Ie)),padding:`0 3px`,color:`var(--text)`,fontSize:e.fontSize,fontVariantNumeric:`tabular-nums`,textAlign:`center`,userSelect:`none`}}var Ie;function Le(){return(Le=e((()=>{Ie=.6})))()}function Re(e){let{value:t,min:n,max:r,onChange:i,label:a,help:o,hideLabel:s=!1,disabled:c=!1,testId:l,step:u=1,digits:d=0,unit:f=``}=e,{metrics:p}=C();function m(e){let a=Be(t+e*u,n,r);a!==t&&i(a)}function h(e){let t=He.get(e.key);t===void 0||c||(e.preventDefault(),m(t))}return(0,U.jsx)(b,{label:a,help:o,hideLabel:s,disabled:c,children:(0,U.jsxs)(`span`,{style:Ne(p),"data-testid":l,children:[(0,U.jsx)(`button`,{type:`button`,style:Pe(p,c||t<=n),disabled:c||t<=n,"aria-label":`Decrease ${a}`,onClick:()=>m(-1),onKeyDown:h,children:`−`}),(0,U.jsx)(`span`,{style:Fe(p,ze(e)),"aria-live":`polite`,children:`${T(t,d)}${f}`}),(0,U.jsx)(`button`,{type:`button`,style:Pe(p,c||t>=r),disabled:c||t>=r,"aria-label":`Increase ${a}`,onClick:()=>m(1),onKeyDown:h,children:`+`})]})})}function ze(e){let{min:t,max:n,digits:r=0,unit:i=``}=e;return Math.max(T(t,r).length,T(n,r).length)+i.length}function Be(e,t,n){return se(le(e,Ve),t,n)}var U,Ve,He;function Ue(){return(Ue=e((()=>{ce(),ue(),x(),Le(),w(),U=n(),Ve=10,He=new Map([[`ArrowUp`,1],[`ArrowRight`,1],[`ArrowDown`,-1],[`ArrowLeft`,-1]]),Re.__docgenInfo={description:`A value the reader nudges up and down.
...
@default 0`},unit:{required:!1,tsType:{name:`string`},description:"Written after the value, e.g. `px`.\n@default '' — no unit is written"}}}})))()}function We(e){let{label:t,value:n,keyWord:r=t,showKey:a=!0,swatches:o}=e,{active:s=!1,disabled:c=!1,disabledReason:l}=e,{opensMenu:u=!1,onClick:d,testId:f}=e,{metrics:p}=C(),{hovered:m,focused:h,handlers:g}=ie(),_=`${t} — ${n}`;return(0,W.jsxs)(`button`,{type:`button`,title:c&&l!==void 0?l:_,"aria-label":_,"aria-haspopup":u?`menu`:void 0,"aria-expanded":u?s:void 0,disabled:c,"data-testid":f,style:ne(p,{hovered:m,focused:h,active:s,disabled:c}),onClick:d,...g,children:[o===void 0||o.length===0?null:(0,W.jsx)(z,{colors:o}),a?(0,W.jsx)(`span`,{style:ae(),children:r}):null,(0,W.jsx)(`span`,{style:re(),children:n}),(0,W.jsx)(`span`,{"aria-hidden":`true`,style:te(),children:(0,W.jsx)(i,{icon:`caret-down`,size:Ge(p.fontSize)})})]})}function Ge(e){return e+2}var W;function Ke(){return(Ke=e((()=>{r(),H(),w(),oe(),ee(),W=n(),We.__docgenInfo={description:`A setting written as its own value, with a caret saying it can be changed.
...
@default undefined — nothing of its own happens`},testId:{required:!1,tsType:{name:`string`},description:"Value of the `data-testid` attribute.\n@default undefined"}}}})))()}function G(e){let{label:t,value:n,options:r,onChange:i,keyWord:a,showKey:o}=e,{swatches:s,disabled:c=!1,disabledReason:l}=e,{placement:u=`bottom-end`,testId:d}=e,{metrics:f}=C(),h=(0,K.useId)(),[_,y]=(0,K.useState)(!1),b=n;for(let e of r)e.value===n&&(b=e.label);return(0,q.jsx)(g,{isOpen:_,disabled:c,placement:u,onInteraction:e=>y(e),content:(0,q.jsxs)(p,{role:`listbox`,"aria-labelledby":h,size:f.blueprintSize,style:J,children:[(0,q.jsx)(v,{title:t,titleId:h}),r.map(e=>(0,q.jsx)(m,{roleStructure:`listoption`,selected:e.value===n,text:e.label,htmlTitle:e.title,disabled:e.disabled,onClick:()=>i(e.value)},e.value))]}),children:(0,q.jsx)(We,{label:t,value:b,keyWord:a,showKey:o,swatches:s,active:_,disabled:c,disabledReason:l,testId:d,opensMenu:!0})})}var K,q,J;function Y(){return(Y=e((()=>{d(),_(),f(),h(),K=t(),Ke(),w(),q=n(),J={minWidth:168},G.__docgenInfo={description:`A setting written as its value, whose choices are a menu behind it.
...
@default 'bottom-end'`},testId:{required:!1,tsType:{name:`string`},description:"Value of the `data-testid` attribute of the button.\n@default undefined"}}}})))()}function qe(e){let{value:t,options:n,onChange:r,label:i,help:a,hideLabel:o=!1,disabled:s=!1,testId:c}=e,{metrics:l}=C(),d=y(),{appearance:f=d===void 0?`field`:`quiet`}=e;return f===`quiet`?(0,X.jsx)(b,{label:i,help:a,hideLabel:o,disabled:s,children:(0,X.jsx)(G,{label:i,value:t,options:n,onChange:r,showKey:!1,disabled:s,testId:c})}):(0,X.jsx)(b,{label:i,help:a,hideLabel:o,disabled:s,children:(0,X.jsx)(u,{value:t,disabled:s,large:l.blueprintSize===`large`,"aria-label":i,"data-testid":c,onChange:e=>r(e.currentTarget.value),children:n.map(e=>(0,X.jsx)(`option`,{value:e.value,title:e.title,disabled:e.disabled,children:e.label},e.value))})})}var X;function Je(){return(Je=e((()=>{l(),x(),Y(),S(),w(),X=n(),qe.__docgenInfo={description:`The picker a card reaches for once the choices stop fitting side by side.
...
@default 'quiet' inside an OverlayPanel, 'field' anywhere else`}}}})))()}function Ye(e){let t=Math.round(e.controlHeight*.75/2)*2,n=Math.round(t*5/3),r=t-4;return{width:n,height:t,knob:r,inset:2,travel:n-r-4}}function Xe(e,t,n){return{display:`inline-flex`,alignItems:`center`,minWidth:t.width,height:e.controlHeight,padding:0,border:`none`,background:`transparent`,cursor:n?`default`:`pointer`,opacity:n?.6:1}}function Ze(e,t){return{position:`relative`,display:`inline-block`,width:e.width,height:e.height,borderRadius:999,background:t?`var(--accent)`:`var(--border-strong)`,transition:`background ${Z}ms ease`}}function Qe(e,t){return{position:`absolute`,top:e.inset,left:t?e.inset+e.travel:e.inset,width:e.knob,height:e.knob,borderRadius:`50%`,background:`var(--surface)`,boxShadow:`var(--shadow-sm)`,transition:`left ${Z}ms ease`}}var Z;function $e(){return($e=e((()=>{Z=150})))()}function et(e){let{checked:t,onChange:n,label:r,help:i,hideLabel:a=!1,disabled:o=!1,testId:c,swatch:l,icon:u}=e,{metrics:d}=C(),f=y();if((e.appearance??(f===void 0?`button`:`switch`))===`switch`){let e=Ye(d);return(0,Q.jsx)(b,{label:r,help:i,hideLabel:a,disabled:o,children:(0,Q.jsx)(`button`,{type:`button`,"aria-pressed":t,"aria-label":r,disabled:o,"data-testid":c,style:Xe(d,e,o),onClick:()=>n(!t),children:(0,Q.jsx)(`span`,{style:Ze(e,t),children:(0,Q.jsx)(`span`,{style:Qe(e,t)})})})})}return(0,Q.jsx)(b,{label:r,help:i,hideLabel:!0,disabled:o,children:(0,Q.jsx)(s,{variant:`minimal`,size:d.blueprintSize,active:t,disabled:o,"aria-pressed":t,"aria-label":r,title:a?r:void 0,icon:l===void 0?u:(0,Q.jsx)(`span`,{style:Se(l)}),text:a?void 0:r,"data-testid":c,onClick:()=>n(!t)})})}var Q;function $(){return($=e((()=>{c(),x(),xe(),S(),w(),$e(),Q=n(),et.__docgenInfo={description:`One thing on the figure turned on and off.
...
@default undefined`}}}})))()}export{G as a,Ue as c,Ee as d,Oe as f,Je as i,z as l,$ as n,Y as o,qe as r,Re as s,et as t,H as u};