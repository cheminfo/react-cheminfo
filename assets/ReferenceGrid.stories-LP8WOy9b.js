import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{n as t}from"./iframe-q9lSOsQA.js";import{n}from"./joinClassNames-BbK_6p9Z.js";import{n as r,r as i}from"./familyTokens-DsQXXJV4.js";import{p as a,u as o,v as s}from"./pedagogyFixtures-CJW_gw23.js";import{n as c,t as l}from"./ReferenceSectionBlock-DpDeZzFV.js";function u(e){let{sections:t,minColumnWidth:r=320,syntaxWidth:i=150,className:a}=e;return(0,f.jsx)(`div`,{className:n(`reference-grid`,a),style:d(r),children:t.map(e=>(0,f.jsx)(l,{section:e,syntaxWidth:i},e.id))})}function d(e){return{display:`grid`,gridTemplateColumns:`repeat(auto-fit, minmax(${e}px, 1fr))`,gap:`10px 24px`,alignItems:`start`}}var f;function p(){return(p=e((()=>{c(),f=t(),u.__docgenInfo={description:`The whole cheatsheet: as many columns as the paper or the window allows.
