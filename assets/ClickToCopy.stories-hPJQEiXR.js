...
}`,...m.parameters?.docs?.source},description:{story:"The family's selection policy: the text of a tool is not selectable, a field\nis, and a region marked `selectable` is read and quoted.",...m.parameters?.docs?.description}}},h=[`Default`,`Formula`,`TableCells`,`InsideClickableRow`,`SelectionPolicy`]})))()}g();export{u as Default,d as Formula,p as InsideClickableRow,m as SelectionPolicy,f as TableCells,h as __namedExportsOrder,l as default};