...
const STORY_IDS = [
  ...
  'help-helpicon--plain-content',
  'help-helpicon--several-examples',
  ...
  'orbital-radialplot--color-blind-safe-in-angstrom',
  'orbital-radialplot--default',
  'orbital-radialplot--with-amplitude',
  'orbital-radialplot--with-caption',
  ...
  'parallel-parallelcoordinates--brushing',
  'parallel-parallelcoordinates--coded-axis',
  'parallel-parallelcoordinates--default',
  'parallel-parallelcoordinates--hover-card',
  'parallel-parallelcoordinates--moving-an-axis',
  'parallel-parallelcoordinates--picking-a-line',
  'parallel-parallelcoordinates--several-intervals',
  ...
  'scatter-scattercloud--named-samples',
  'scatter-scattercloud--no-shells',
  'scatter-scattercloud--projected-samples',
  'scatter-scattercloud--square-on',
  ...
  'scatter-scatterplot--open-on-double-click',
  ...
  'share-sharedialog--with-presets',
